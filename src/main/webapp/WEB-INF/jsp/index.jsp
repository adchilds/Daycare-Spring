    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p><a href="/pricing.html" class="btn btn-default">View options</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Need an account?</h2>
                <p>Registering up for our service is easy. We have many different plans available to fit your needs. Simply select a plan and provide the necessary information and we'll be ready to help your business needs.</p>
                <p><a href="/register.html" class="btn btn-primary">Register</a></p>
            </div>
        </div>
    </div>
</div>